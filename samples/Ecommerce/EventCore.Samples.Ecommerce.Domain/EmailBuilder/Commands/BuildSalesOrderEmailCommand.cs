...
namespace EventCore.Samples.Ecommerce.Domain.EmailBuilder.Commands
{
	public class BuildSalesOrderEmailCommand : EmailBuilderCommand
	{
		...
		public BuildSalesOrderEmailCommand(CommandMetadata _metadata, Guid emailId, string customerEmail, string salesOrderId, decimal totalPrice) : base(_metadata, emailId)
		{
