...
namespace EventCore.Samples.DemoCli
{
	public class Program
	{
		public static Task Main(string[] args)
		{
			...
			Parser.Default.ParseArguments<Options.CommitOptions, Options.LoadOptions, Options.SubscribeOptions>(args)
				...
				.WithParsed<Options.SubscribeOptions>(options => new Actions.SubscribeAction(options).RunAsync().Wait());
